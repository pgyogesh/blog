...
### CREATE FUNCTION
Function Source: [periscopedata.com](https://www.periscopedata.com/blog/exact-row-counts-for-every-database-table){:target="_blank"}
...
SELECT
     n.nspname as "Schema",
     c.relname as "Table",
     count_rows(n.nspname, c.relname) as "Row count"
